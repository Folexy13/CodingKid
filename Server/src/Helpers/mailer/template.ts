// Import types
import {
  ContactUsTemplateDataType,
  SubscribeTemplateDataType,
  OtpMailTemplateDataType,
} from "../types";

export const contactUsTemplate = async ({
  name,
  email,
  phone,
  subject,
...
export const subscribeTemplate = async ({
  firstName,
  email,
}: SubscribeTemplateDataType) => {
  return `
...
<body style="margin:100px auto; padding: 0; width: 700px; word-break: break-word; -webkit-font-smoothing: antialiased; --bg-opacity: 1; background-color: #eceff1; background-color: rgba(236, 239, 241, var(--bg-opacity));">
            ...
            <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; background-color: rgba(255, 255, 255, var(--bg-opacity)); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262; color: rgba(98, 98, 98, var(--text-opacity));" bgcolor="rgba(255, 255, 255, var(--bg-opacity))" align="left">
             <h3>Coding Kid Africa,</h3>
              ...
              <p style="margin: 0 0 16px;">
                ...
                <a href=mailto:folajimiopeyemisax13@gmail.com class="hover-underline" style="--text-opacity: 1; color: #7367f0; text-decoration: none;">let us know</a>.
              </p>
              <p style="margin: 0 0 16px;">Thanks, <br>Coding Kid Africa</p>
            </td>
          </tr>
        </table>
      </td>
